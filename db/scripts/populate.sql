...
LOAD DATA LOCAL INFILE 'src/UserData5000.csv' INTO TABLE COMM_USERS
FIELDS TERMINATED BY '|' 
LINES TERMINATED BY '\n'
(FIRST_NAME,LAST_NAME,ADDRESS,CITY,STATE,EMAIL,USERNAME,PASSWORD);

INSERT INTO COMM_USERS (ID, FULL_NAME, FIRST_NAME, LAST_NAME, USERNAME, PASSWORD) VALUES (3, 'Jenny Admin','Jenny','Admin','jadmin','admin');

INSERT INTO COMM_USER_ROLES(USER_ID, ROLE_ID) SELECT ID,2 FROM COMM_USERS;
...
LOAD DATA LOCAL INFILE 'src/AlsoBuyData.csv' INTO TABLE COMM_PRODUCT_BOUGHT
FIELDS TERMINATED BY ',' 
LINES TERMINATED BY '\n'
